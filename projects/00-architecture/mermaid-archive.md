# 🗃️ Mermaid Diagram Archive – Bayko & Brown Architecture (Legacy Drafts)

This document contains the original **Mermaid-based architecture diagrams** created during the early design phase of the Bayko & Brown system.

These diagrams were used as **visual scaffolding** to help conceptualize:

- Multi-agent orchestration flows
- Network segmentation and VPC boundaries
- Secure communication and isolation models
- Output structure and subsystem wiring

They have since been replaced by finalized `.drawio` diagrams exported as PNGs (see `architecture.md`), which better reflect the final system design.

> ⚠️ Note: The diagrams below may contain naming inconsistencies or structural differences compared to the finalized versions. They are preserved here for reference only.
